...
Route::post('/user/cart/update-item', [CartController::class, 'updateItem'])
    ...
    Route::get('/payment/order/{order}/status', [PagesController::class, 'orderPaymentStatus'])->name('payment.order.status');
    ...
    Route::get('/payment/booking/{booking}/status', [PagesController::class, 'bookingPaymentStatus'])->name('payment.booking.status');
    //payments
