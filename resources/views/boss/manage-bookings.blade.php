...
<div class="row">
    <div class="col-md-12">
        @include('partials.admin-table-search', ['tableId' => 'boss-bookings-table', 'placeholder' => 'Tìm khách hàng, sân, ngày đặt...'])
        <div class="table-responsive">
            <table id="boss-bookings-table" class="table table-striped table-hover">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Khách hàng</th>
