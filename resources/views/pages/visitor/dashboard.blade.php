...
.between-img:hover {
            ...
            <div class="col-lg-8">
                ...
                <div class="section-block mt-4">
                    ...
                    <div class="intro-box">
                        ...
                        <a href="{{route('visitor.fields')}}" class="btn btn-sm btn-warning">Xem ngay</a>
                    </div>
    ...
    <script>
     ...
     <a href ="{{route('visitor.fields')}}">
    <div id="toast-rule" class="toast-noti">
    <i class="bi bi-megaphone-fill"></i>
    <div class="toast-content">
        <strong>Thông báo</strong>
        <p>🔥 Giờ cao điểm {{optional($rule)->start_time}} - {{optional($rule) ->end_time}} (giá x{{$rule->multiplier}})</p>
    </div>
...
<p>🔥 {{ optional($ruleService)->note }}</p>    </div>
