...
<div class="section bg-light">
    <div class="container fade-in">
        ...
        <p>
            Nhận thấy những hạn chế đó, nhóm phát triển đã từng bước xây dựng Football Booking như một giải pháp ứng dụng công nghệ vào quản lý và đặt sân bóng. Ban đầu, hệ thống chỉ tập trung vào chức năng đặt sân cơ bản. Qua thời gian, dựa trên nhu cầu thực tế và phản hồi từ người dùng, Football Booking được mở rộng với nhiều tính năng nâng cao.
        </p>
    </div>
</div>
            ...
            <div class="col-md-6 fade-in">
                <div class="card card-hover h-100 border-0 rounded-4">
                    <div class="card-body">
                        ...
                        <p>
                            Mang đến một nền tảng đặt sân bóng hiện đại, thân thiện và dễ sử dụng, giúp mọi người tiếp cận thể thao một cách thuận tiện, nhanh chóng và bền vững. Football Booking hướng tới việc đơn giản hóa quá trình tìm kiếm, đặt sân và sử dụng các dịch vụ đi kèm.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 fade-in">
                <div class="card card-hover h-100 border-0 rounded-4">
                    <div class="card-body">
                        ...
                        <p>
                            Football Booking hướng tới trở thành hệ sinh thái thể thao phong trào hàng đầu Việt Nam, nơi kết nối toàn diện giữa người chơi, chủ sân và các dịch vụ liên quan đến thể thao. Chúng tôi mong muốn góp phần thúc đẩy phong trào thể thao phát triển bền vững.
                        </p>
                    </div>
                </div>
            </div>
